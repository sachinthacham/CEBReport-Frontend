...
const Analysis = () => {
  ...
  const renderSubtopicContent = (subtopicName: string) => {
    switch (subtopicName.toLowerCase()) {
      // Add cases for each subtopic here
      case "consumption analysis":
        return <div>Consumption Analysis Content</div>;
      case "billing analysis":
        return <div>Billing Analysis Content</div>;
      case "payment analysis":
        return <div>Payment Analysis Content</div>;
      default:
        return (
